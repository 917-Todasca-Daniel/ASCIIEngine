...
std::ofstream Debugger::debugLog = std::ofstream("engine/log.txt");
...
void Debugger::initialize() {
	...
	characters.push_back(new Imp("Imp #1"));
	characters.push_back(new Imp("Imp #2"));
	characters.push_back(new Imp("Imp #3"));
	characters.push_back(new Imp("Imp #4"));
	Encounter* enct = new DiningFight(characters);
}
